    ...
    udm_ue_t *udm_ue, ogs_sbi_stream_t *stream, ogs_sbi_message_t *recvmsg)
{
    ...
    CASE(OGS_SBI_RESOURCE_NAME_AUTHENTICATION_SUBSCRIPTION)
        ...
        CASE(OGS_SBI_HTTP_METHOD_GET)
            ...
            if(AuthenticationSubscription->authentication_method == 3) {
                 udm_ue->auth_type = OpenAPI_auth_type_EAP_TLS;
            }else{
        ...
        CASE(OGS_SBI_HTTP_METHOD_PATCH)
            ...
            if(AuthenticationInfoResult.auth_type == OpenAPI_auth_type_5G_AKA){
                ...
                AuthenticationInfoResult.authentication_vector = &AuthenticationVector;

            }else {
                sendmsg.res_status = OGS_SBI_HTTP_STATUS_NO_CONTENT;
            }
